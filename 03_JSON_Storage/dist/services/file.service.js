...
class FileService {
    createJson(bucketName, jsonName, data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                throw api_error_1.default.BadRequest('file or folder creation error!');
            }
        });
    }
    getJsonData(jsonPath) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                throw api_error_1.default.BadRequest('file reading error');
            }
        });
    }
}
